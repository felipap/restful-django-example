# Django settings for worddb project.
...
SECRET_KEY = 'eq11!jt5r1n*qime&wxum7gl$$n%uph!a9^v%stp(nldbzu8v_'
...
MIDDLEWARE_CLASSES = (
    ...
    'worddb.app.helpers.CustomMiddleware',
)

ROOT_URLCONF = 'worddb.urls'
